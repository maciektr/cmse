...
\begin{document}
    ...
    \section{Błędy zaokrągleń i odwzorowanie logistyczne}
        ...
        \begin{figure}[h!]
            \centering
            \subfloat[$x_0=0.7;r\in(3.5, 4.0)$]{\includegraphics[width=5cm]{lab1/img/Bifurcation_3.png}}
            \subfloat[$x_0=0.8;r\in(1.0, 4.0)$]{\includegraphics[width=5cm]{lab1/img/Bifurcation_6.png}}
            \caption{Diagram bifurkacyjny.}
        \end{figure}\\
