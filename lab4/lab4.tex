...
\begin{document}
    ...
    \section{Sudoku}
        ...
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s1_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s1_1.png}}
            \caption{Przykład 1.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s2_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s2_1.png}}
            \caption{Przykład 2.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s3_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s3_1.png}}
            \caption{Przykład 3.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s4_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s4_1.png}}
            \caption{Przykład 4.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s5_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s5_1.png}}
            \caption{Przykład 5.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s6_0.png}}
            \subfloat[]{\includegraphics[width=8cm]{lab4/img/sudoku/s6_1.png}}
            \caption{Przykład 6.}
        \end{figure}\\
