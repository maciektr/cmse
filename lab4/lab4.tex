...
\begin{document}
    ...
    \section{Sudoku}
        ...
        \begin{figure}[h!]
            ...
            \subfloat[]{\includegraphics[width=9cm]{lab4/img/sudoku/s1_1.png}}
            \caption{Przykład 1.}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
        ...
        \begin{figure}[h!]
            \centering
            \subfloat[]{\includegraphics[width=6cm]{lab4/img/sudoku/s3_0.png}}
            \subfloat[]{\includegraphics[width=6cm]{lab4/img/sudoku/s3_1.png}}
            \caption{Przykład 3.}
        \end{figure}\\
