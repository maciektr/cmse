...
\begin{document}
    ...
    \section{Wyszukiwanie wprowadzonego hasła}
        ...
        \begin{figure}[h!]
            \centering
            \subfloat[$k=20$]{\includegraphics[width=7cm]{lab6/img/front_result1_k20.png}}
            \subfloat[$k=40$]{\includegraphics[width=7cm]{lab6/img/front_result1_k40.png}}\\
            \subfloat[$k=60$]{\includegraphics[width=7cm]{lab6/img/front_result1_k60.png}}
            \subfloat[$k=80$]{\includegraphics[width=7cm]{lab6/img/front_result1_k80.png}}\\
            \subfloat[$k=100$]{\includegraphics[width=7cm]{lab6/img/front_result1_k100.png}}
            \subfloat[$k=300$]{\includegraphics[width=7cm]{lab6/img/front_result1_idf_svd.png}}
            \caption{Zapytanie testowe: "Toyota"}
        \end{figure}\\
        \begin{figure}[h!]
            \centering
            \subfloat[$k=20$]{\includegraphics[width=7cm]{lab6/img/front_result2_k20.png}}
            \subfloat[$k=40$]{\includegraphics[width=7cm]{lab6/img/front_result2_k40.png}}\\
            \subfloat[$k=60$]{\includegraphics[width=7cm]{lab6/img/front_result2_k60.png}}
            \subfloat[$k=80$]{\includegraphics[width=7cm]{lab6/img/front_result2_k80.png}}\\
            \subfloat[$k=100$]{\includegraphics[width=7cm]{lab6/img/front_result2_k100.png}}
            \subfloat[$k=300$]{\includegraphics[width=7cm]{lab6/img/front_result2_idf_svd.png}}
